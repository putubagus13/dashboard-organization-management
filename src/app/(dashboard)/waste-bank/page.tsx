...
export default async function WasteBankPage() {
  ...
  const statusColor = (s: string) => (s === 'completed' ? 'success' : s === 'ongoing' ? 'warning' : 'default');
  const statusLabel = (s: string) => (s === 'completed' ? 'Selesai' : s === 'ongoing' ? 'Berlangsung' : 'Dibatalkan');
    ...
    <div className="space-y-6">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
        <StatCard
          ...
          value={formatWeight(monthWeight)}
          icon={Scale}
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2 flex-wrap">
                    ...
                    <Badge variant={statusColor(s.status)} size="sm">
        ...
        <div className="space-y-4">
          ...
          <div className="bento-card p-5">
            <div className="flex items-center justify-between mb-3">
              ...
              <Link href="/waste-bank/leaderboard" className="text-sm text-brand-700 hover:underline">
                Semua
              </Link>
            </div>
            <div className="space-y-2">
