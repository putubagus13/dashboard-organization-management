...
export default async function DashboardPage() {
  ...
  const [
    ...
    supabase
      ...
      .select('total_weight,total_earnings,session_date')
  ...
  const { data: topWaste } = await supabase
    .from('waste_collectors')
    .select('id,name,total_weight,total_earnings')
    .is('deleted_at', null)
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title="Dashboard"
        description={`Selamat datang kembali! ${formatDate(now.toISOString(), 'EEEE, d MMMM yyyy')}`}
      />
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <StatCard
          ...
          subtitle={`${activeMembers ?? 0} aktif`}
          icon={Users}
        ...
        <StatCard
          ...
          subtitle={`${accounts?.length ?? 0} rekening`}
          icon={Wallet}
        ...
        <StatCard
          ...
          subtitle={`Pengeluaran: ${formatCurrency(expenseThisMonth)}`}
          icon={TrendingUp}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <StatCard
          ...
          value={formatCurrency(duePaidAmount)}
        ...
        <StatCard
          ...
          value={`${wasteWeight.toFixed(1)} kg`}
        ...
        />
        <StatCard
          title="Pendapatan Sampah"
          value={formatCurrency(wasteEarnings)}
          icon={Activity}
        ...
        <div className="space-y-4">
          ...
          <div className="bento-card p-5">
            <div className="flex items-center justify-between mb-4">
              ...
              <Link href="/waste-bank/leaderboard" className="text-sm text-brand-700 hover:underline font-medium">
                Semua
              </Link>
            </div>
            <div className="space-y-2">
          ...
          <div className="bento-card p-5">
            <div className="flex items-center justify-between mb-4">
              ...
              <Link href="/members" className="text-sm text-brand-700 hover:underline font-medium">
                Semua
              </Link>
            </div>
            <div className="space-y-2">
